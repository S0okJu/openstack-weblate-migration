...
source $SCRIPTSDIR/prepare_component_name/get_component_name.sh
...
# Create Zanata Config XML file
# and pull source and translation files from Zanata.
# Make components lists for creating Weblate components.
case $PROJECT in
    api-site)
        setup_manuals

...
class TestResult:
    ...
    def _ensure_category(self, project_name: str,
    ...
    def add_locale_result_failed(
        ...
        :param category_name: Name of the category/version
        ...
        component = self._ensure_component(
    ...
    def add_locale_result_success(
        ...
        :param weblate_missing_count: Number of entries missing
    ...
    def get_component_locales(
        ...
        try:
            return list(
                self.projects[project_name][category_name]
    ...
    def get_success_rate(
        ...
        """
        locales = self.get_component_locales(
            project_name, category_name, component_name)
        if not locales:
            return 0.0

        component = self.projects[project_name][
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"<TestResult: {total_projects} projects, "
            f"{total_tests} tests>"
        )
